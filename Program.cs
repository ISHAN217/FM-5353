// MonteCarloDeltaControlVariate.csproj target: net8.0 (Console)
// Full, self-contained implementation with four configurations:
// None, Antithetic, DeltaCV, Antithetic+DeltaCV.
// Includes Normal CDF, Black–Scholes price and delta, GBM path gen, delta-based CV, and a test harness.
...
public sealed class McPricer
{
        ...
        out double stdError)
    {
        ...
        // Welford on undiscounted adjusted payoff Y; discount at the end
...
public static class Program
{
    static void Main()
    {
        ...
        Report(pricer, S0, K, r, q, sigma, T, steps, nSamples, payoffCall, deltaCall, VarianceReduction.None, "None");
        Report(pricer, S0, K, r, q, sigma, T, steps, nSamples, payoffCall, deltaCall, VarianceReduction.Antithetic, "Antithetic");
        Report(pricer, S0, K, r, q, sigma, T, steps, nSamples, payoffCall, deltaCall, VarianceReduction.DeltaControlVariate, "Delta-CV");
        Report(pricer, S0, K, r, q, sigma, T, steps, nSamples, payoffCall, deltaCall, VarianceReduction.Antithetic | VarianceReduction.DeltaControlVariate, "Antithetic + Delta-CV");
    }
        ...
        VarianceReduction vr, string label)
    {
        ...
        Console.WriteLine($"{label,-22}  Price = {price,10:F6}   StdErr = {se,10:F6}   Time = {ms,8:F1} ms");
    }
}